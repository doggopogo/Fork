...
val hydration = Color(0xFF70ACE8)
val food = Color(0xFF92C570)
val supplements = Color(0xFFBCB8B0)
val sleep = Color(0xFF404395)
val toilet = Color(0xFFD5C095)
val activity = Color(0xFFAA55D9)
val weight = Color(0xFF3E7D65)
val alcohol = Color(0xFFD8E885)
val bloodSugar = Color(0xFFD14F4F)
