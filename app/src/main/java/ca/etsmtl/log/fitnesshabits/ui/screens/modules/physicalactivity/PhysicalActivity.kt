package ca.etsmtl.log.fitnesshabits.ui.screens.modules.physicalactivity
...
fun PhysicalActivity(navController: NavController) {
    Column {
        Header(title = "Physical Activity", R.color.activity, navigateBack = { navController.navigateUp() })
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Row (
                ...
                EditTargetButton("10L", R.color.activity) {}
            }
