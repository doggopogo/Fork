package ca.etsmtl.log.fitnesshabits.ui.screens.modules.diabetes
...
@Composable
fun Diabetes(navController: NavController) {
    Column {
        Header(title = "Diabetes", R.color.bloodSugar, navigateBack = { navController.navigateUp() })
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Row (
                ...
                EditTargetButton("10L", R.color.bloodSugar) {}
            }
            DataListDisplay(
